...
for ANNOT_DIR in $(echo $ANNOT_DIRS/*) # only does coccinella like this! remove "C_s" to get all species again
do 
    cd $ANNOT_DIR
    ANNOT_GTF=$ANNOT_DIR/braker/braker_isoform_filtered.gff #### TODO add condition to see if it's gff or gtf
