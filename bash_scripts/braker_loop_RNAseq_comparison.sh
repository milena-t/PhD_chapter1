...
# Lu2024
cd /proj/naiss2023-6-65/Milena/annotation_pipeline/RNA_proteinrefs_annotation/annotation_species/superscaffolded_comparison/Cmac_Lu2024_simple

sbatch --job-name="Cmac_scaff_Lu2024" --output="Cmac_scaff_Lu2024.out" -t 5-00:00:00 \
/proj/naiss2023-6-65/Milena/annotation_pipeline/braker3_singularity_with_RNAseq_in_SNIC_TMP.sh Cmac_Lu2024 assembly_genomic.fna.masked \
