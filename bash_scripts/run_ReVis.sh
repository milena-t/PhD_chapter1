...
for SPECIES in A_verrucosus C_chinensis C_septempunctata D_melanogaster D_ponderosae I_luminosus P_pyralis R_ferrugineus T_castaneum T_molitor Z_morio #A_obtectus B_siliquastri C_maculatus
do
    echo ""
    echo ""
    echo "--------------------------------------------------------------------------------------------------------------"
    ...
    python3 /Users/${U_NAME}/work/PhD_code/ReVis/src/ReVis/ReVis_transcript_surroundings.py \
        ...
        --masker_outfile /Users/${U_NAME}/work/repeatmasking/repeat_gffs/${SPECIES}_masking.ori.out \
